...
public class TestVentasS2 {
	...
	public static void main(String[] args) throws UnknownHostException {
		//INSTANCIAS
	     ...
	     Venta venta = new Venta(new Date(),"0002-1",formaDePago,clienteDao.traerCliente(22222222),atencionS2,cajaS2);	   
		 ...
		 Venta venta2 = new Venta(new Date(),"0002-2",formaDePago2,clienteDao.traerCliente(33333333),atencionS2,cajaS2);	   
		 ...
		 Venta venta3 = new Venta(new Date(),"0002-3",formaDePago,clienteDao.traerCliente(33333333),atencionS2,cajaS2);	   
		 ...
		 Venta venta4 = new Venta(new Date(),"0002-4",formaDePago2,clienteDao.traerCliente(22222222),atencionS2,cajaS2);	   
		 ...
		 Venta venta5 = new Venta(new Date(),"0002-5",formaDePago,clienteDao.traerCliente(33333333),atencionS2,cajaS2);	   
		 ...
		 Venta venta6 = new Venta(new Date(),"0002-6",formaDePago2,clienteDao.traerCliente(44444444),atencionS2,cajaS2);	   
		 ...
		 Venta venta7 = new Venta(new Date(),"0002-7",formaDePago,clienteDao.traerCliente(44444444),atencionS2,cajaS2);	   
		 ...
		 Venta venta8 = new Venta(new Date(),"0002-8",formaDePago2,clienteDao.traerCliente(22456789),atencionS2,cajaS2);	   
		 ...
		 Venta venta9 = new Venta(new Date(),"0002-9",formaDePago,clienteDao.traerCliente(22456789),atencionS2,cajaS2);	   
		 ...
		 Venta venta10 = new Venta(new Date(),"0002-10",formaDePago2,clienteDao.traerCliente(22456789),atencionS2,cajaS2);	   
		 ...
		 Venta venta11 = new Venta(new Date(),"0002-11",formaDePago,clienteDao.traerCliente(33445566),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 ...
		 Venta venta12 = new Venta(new Date(),"0002-12",formaDePago2,clienteDao.traerCliente(33445566),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 ...
		 Venta venta13 = new Venta(new Date(),"0002-13",formaDePago,clienteDao.traerCliente(12344455),atencionS2,cajaS2);	   
		 ...
		 Venta venta14 = new Venta(new Date(),"0002-14",formaDePago,clienteDao.traerCliente(12344455),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 ...
		 Venta venta15 = new Venta(new Date(),"0002-15",formaDePago2,clienteDao.traerCliente(12345678),atencionS2,cajaS2);	   
