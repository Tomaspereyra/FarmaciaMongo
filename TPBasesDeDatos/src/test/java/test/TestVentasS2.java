...
public class TestVentasS2 {
	...
	public static void main(String[] args) throws UnknownHostException {
		//INSTANCIAS
		 ...
		 Venta venta16 = new Venta(new Date(),"0002-16",0,formaDePago2,clienteDao.traerCliente(12345678),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Perfume"),6);
		 venta16.agregarItem(item);	   
		 ventaDao.agregarVenta(venta16); 
		 
		 Venta venta17 = new Venta(new Date(),"0002-17",0,formaDePago,clienteDao.traerCliente(40894068),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Perfume2"),3);
		 venta17.agregarItem(item);	   
		 ventaDao.agregarVenta(venta17); 
		 
		 Venta venta18 = new Venta(new Date(),"0002-18",0,formaDePago2,clienteDao.traerCliente(40894068),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Perfume2"),1);
		 venta18.agregarItem(item);	   
		 ventaDao.agregarVenta(venta18); 
		 
		 Venta venta19 = new Venta(new Date(),"0002-19",0,formaDePago,clienteDao.traerCliente(40894068),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 ...
		 Venta venta20 = new Venta(new Date(),"0002-20",0,formaDePago,clienteDao.traerCliente(40894068),atencionS2,cajaS2);	   
		 ...
		 Venta venta21 = new Venta(new Date(),"0002-21",0,formaDePago,clienteDao.traerCliente(40894068),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Ibuprofeno"),1);
		 ...
		 Venta venta22 = new Venta(new Date(),"0002-22",0,formaDePago2,clienteDao.traerCliente(40867986),atencionS2,cajaS2);	   
		 ...
		 Venta venta23 = new Venta(new Date(),"0002-23",0,formaDePago2,clienteDao.traerCliente(40867986),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Paracetamol"),1);
		 item2= new ItemVenta(productoDao.traerProducto("Perfume2"),1);
		 item3 = new ItemVenta(productoDao.traerProducto("Amoxicilina"),1);
		 ...
		 Venta venta24 = new Venta(new Date(),"0002-24",0,formaDePago2,clienteDao.traerCliente(40867986),atencionS2,cajaS2);	   
		 ...
		 Venta venta25 = new Venta(new Date(),"0002-25",0,formaDePago,clienteDao.traerCliente(38678945),atencionS2,cajaS2);	   
		 ...
		 Venta venta26 = new Venta(new Date(),"0002-26",0,formaDePago,clienteDao.traerCliente(38678945),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Desodorante"),2);
		 ...
		 Venta venta27 = new Venta(new Date(),"0002-27",0,formaDePago,clienteDao.traerCliente(38678945),atencionS2,cajaS2);	   
		 ...
		 Venta venta28 = new Venta(new Date(),"0002-28",0,formaDePago,clienteDao.traerCliente(22222222),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Desodorante"),2);
		 ...
		 Venta venta29 = new Venta(new Date(),"0002-29",0,formaDePago,clienteDao.traerCliente(38678945),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Paracetamol"),1);
		 venta29.agregarItem(item);	   
		 ventaDao.agregarVenta(venta29); 
		 
		 Venta venta30 = new Venta(new Date(),"0002-30",0,formaDePago,clienteDao.traerCliente(22222222),atencionS2,cajaS2);	   
		 item = new ItemVenta(productoDao.traerProducto("Ibuprofeno600"),2);
