...
public class TestVentasS1 {
	...
	public static void main(String[] args) throws UnknownHostException, ParseException {
		//INSTANCIAS
	     ...
	     Venta venta = new Venta(fecha,"0001-1",formaDePago,clienteDao.traerCliente(22222222),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Perfume"),2);
		 venta.agregarItem(item);	   
		 ventaDao.agregarVenta(venta); 
		 
		 Venta venta2 = new Venta(fecha,"0001-2",formaDePago2,clienteDao.traerCliente(33333333),atencionS1,cajaS1);	   
		 ...
		 Venta venta3 = new Venta(fecha,"0001-3",formaDePago,clienteDao.traerCliente(33333333),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Ibuprofeno"),2);
		 venta3.agregarItem(item);	   
		 ventaDao.agregarVenta(venta3); 
		 
		 Venta venta4 = new Venta(fecha,"0001-4",formaDePago2,clienteDao.traerCliente(22222222),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Ibuprofeno600"),1);
		 venta4.agregarItem(item);	   
		 ventaDao.agregarVenta(venta4); 
		 
		 Venta venta5 = new Venta(fecha,"0001-5",formaDePago,clienteDao.traerCliente(33333333),atencionS1,cajaS1);	   
		 ...
		 Venta venta6 = new Venta(fecha,"0001-6",formaDePago2,clienteDao.traerCliente(44444444),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Aspirina"),4);
		 venta6.agregarItem(item);	   
		 ventaDao.agregarVenta(venta6); 
		 
		 Venta venta7 = new Venta(fecha,"0001-7",formaDePago,clienteDao.traerCliente(44444444),atencionS1,cajaS1);	   
		 ...
		 Venta venta8 = new Venta(fecha,"0001-8",formaDePago2,clienteDao.traerCliente(22456789),atencionS1,cajaS1);	   
		 ...
		 Venta venta9 = new Venta(fecha,"0001-9",formaDePago,clienteDao.traerCliente(22456789),atencionS1,cajaS1);	   
		 ...
		 Venta venta10 = new Venta(fecha,"0001-10",formaDePago2,clienteDao.traerCliente(22456789),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("SolucionFisiologica"),1);
		 ...
		 Venta venta11 = new Venta(fecha,"0001-11",formaDePago,clienteDao.traerCliente(33445566),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 ...
		 Venta venta12 = new Venta(fecha,"0001-12",formaDePago2,clienteDao.traerCliente(33445566),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 ...
		 Venta venta13 = new Venta(fecha,"0001-13",formaDePago,clienteDao.traerCliente(12344455),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Amoxicilina"),1);
		 venta13.agregarItem(item);	   
		 ventaDao.agregarVenta(venta13); 
		 
		 Venta venta14 = new Venta(fecha,"0001-14",formaDePago,clienteDao.traerCliente(12344455),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 venta14.agregarItem(item);	   
		 ventaDao.agregarVenta(venta14); 
		 
		 Venta venta15 = new Venta(fecha,"0001-15",formaDePago2,clienteDao.traerCliente(12345678),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("SolucionFisiologica"),4);
		 venta15.agregarItem(item);	   
		 ventaDao.agregarVenta(venta15); 
		 
		 Venta venta16 = new Venta(fecha2,"0001-16",formaDePago2,clienteDao.traerCliente(12345678),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Perfume"),6);
		 venta16.agregarItem(item);	   
		 ventaDao.agregarVenta(venta16); 
		 
		 Venta venta17 = new Venta(fecha2,"0001-17",formaDePago,clienteDao.traerCliente(40894068),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Perfume2"),3);
		 venta17.agregarItem(item);	   
		 ventaDao.agregarVenta(venta17); 
		 
		 Venta venta18 = new Venta(fecha2,"0001-18",formaDePago2,clienteDao.traerCliente(40894068),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Perfume2"),1);
		 venta18.agregarItem(item);	   
		 ventaDao.agregarVenta(venta18); 
		 
		 Venta venta19 = new Venta(fecha2,"0001-19",formaDePago,clienteDao.traerCliente(40894068),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Amlodipina"),1);
		 ...
		 Venta venta20 = new Venta(fecha2,"0001-20",formaDePago,clienteDao.traerCliente(40894068),atencionS1,cajaS1);	   
		 ...
		 Venta venta21 = new Venta(fecha2,"0001-21",formaDePago,clienteDao.traerCliente(40894068),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Ibuprofeno"),1);
		 ...
		 Venta venta22 = new Venta(fecha2,"0001-22",formaDePago2,clienteDao.traerCliente(40867986),atencionS1,cajaS1);	   
		 ...
		 Venta venta23 = new Venta(fecha2,"0001-23",formaDePago2,clienteDao.traerCliente(40867986),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Paracetamol"),1);
		 item2= new ItemVenta(productoDao.traerProducto("Perfume2"),1);
		 item3 = new ItemVenta(productoDao.traerProducto("Amoxicilina"),1);
		 ...
		 Venta venta24 = new Venta(fecha2,"0001-24",formaDePago2,clienteDao.traerCliente(40867986),atencionS1,cajaS1);	   
		 ...
		 Venta venta25 = new Venta(fecha2,"0001-25",formaDePago,clienteDao.traerCliente(38678945),atencionS1,cajaS1);	   
		 ...
		 Venta venta26 = new Venta(fecha2,"0001-26",formaDePago,clienteDao.traerCliente(38678945),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Desodorante"),2);
		 ...
		 Venta venta27 = new Venta(fecha2,"0001-27",formaDePago,clienteDao.traerCliente(38678945),atencionS1,cajaS1);	   
		 ...
		 Venta venta28 = new Venta(fecha2,"0001-28",formaDePago,clienteDao.traerCliente(22222222),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Desodorante"),2);
		 ...
		 Venta venta29 = new Venta(fecha2,"0001-29",formaDePago,clienteDao.traerCliente(38678945),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Paracetamol"),1);
		 venta29.agregarItem(item);	   
		 ventaDao.agregarVenta(venta29); 
		 
		 Venta venta30 = new Venta(fecha2,"0001-30",formaDePago,clienteDao.traerCliente(22222222),atencionS1,cajaS1);	   
		 item = new ItemVenta(productoDao.traerProducto("Ibuprofeno600"),2);
